...
public class ByteUtil {
	...
	private static void test_splitUint8To2bytes() {
		...
		if (result[0] == 1 && result[1] == 4) {
			LogUtils.debug("test_splitUint8To2bytes(): pass");
		} else {
			LogUtils.debug("test_splitUint8To2bytes(): fail");
		}
	}
	...
	private static void test_combine2bytesToOne() {
		...
		if (combine2bytesToOne(high, low) == 20) {
			LogUtils.debug("test_combine2bytesToOne(): pass");
		} else {
			LogUtils.debug("test_combine2bytesToOne(): fail");
		}
	}
	...
	private static void test_convertChar2Uint8() {
		...
		if (convertByte2Uint8(b1) == 97 && convertByte2Uint8(b2) == 128
			...
			LogUtils.debug("test_convertChar2Uint8(): pass");
		} else {
			LogUtils.debug("test_convertChar2Uint8(): fail");
		}
	}
	...
	private static void test_convertUint8toByte() {
		...
		if (convertUint8toByte(c1) == 97 && convertUint8toByte(c2) == -128
			...
			LogUtils.debug("test_convertUint8toByte(): pass");
		} else {
			LogUtils.debug("test_convertUint8toByte(): fail");
		}
	}
    ...
    private static void test_parseBssid() {
        ...
        {
            LogUtils.debug("test_parseBssid(): pass");
        }
        else
        {
            LogUtils.debug("test_parseBssid(): fail");
        }
    }
